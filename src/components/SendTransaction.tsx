...
const SendTransaction = () => {
  ...
  const isFormValid = recipientAddress && amount && Object.keys(errors).length === 0;
        ...
        {isPending && (
          <div className="rounded-lg bg-yellow-50 border border-yellow-200 px-4 py-3">
            <div className="flex items-center">
              ...
              <span className="text-yellow-800 text-sm">Check your wallet to confirm the transaction</span>
            </div>
          </div>
        )}
